...
abstract class AppLocalizations {
  ...
  /// Label for download quality option
  ///
  /// In en, this message translates to:
  /// **'Download Quality'**
  String get downloadQuality;

  /// Option for Wi-Fi only downloads
  ///
  /// In en, this message translates to:
  /// **'Wi-Fi Only Downloads'**
  String get wifiOnlyDownloads;

  /// Label for playback quality option
  ///
  /// In en, this message translates to:
  /// **'Playback Quality'**
  String get playbackQuality;

  /// Option for enabling subtitles
  ///
  /// In en, this message translates to:
  /// **'Subtitles'**
  ...
  /// Option for auto-playing trailers
  ///
  /// In en, this message translates to:
  /// **'Auto-Play Trailers'**
